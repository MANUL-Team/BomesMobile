package com.MANUL.Bomes.domain.ExplosionField;
...
public class ExplosionAnimator extends ValueAnimator {
    ...
    private static final Interpolator DEFAULT_INTERPOLATOR = new AccelerateInterpolator(0.4f);
    private static final float END_VALUE = 1.4f;
    private static final float X = Utils.dp2Px(5);
    private static final float Y = Utils.dp2Px(20);
    private static final float V = Utils.dp2Px(2) * 1.8f;
